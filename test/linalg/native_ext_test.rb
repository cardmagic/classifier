...
class NativeExtTest < Minitest::Test
  ...
  def test_matrix_alloc
    ...
    assert_equal 2.0, m[0, 1]
    assert_equal 3.0, m[1, 0]
    assert_equal 4.0, m[1, 1]
  end
  ...
  def test_matrix_diag
    ...
    assert_equal 1.0, m[0, 0]
    assert_equal 2.0, m[1, 1]
    assert_equal 3.0, m[2, 2]
